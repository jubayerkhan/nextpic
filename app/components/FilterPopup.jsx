    ...
    return (
        <div className="filter_div">
            ...
            <div className="md:flex justify-between items-center">
                ...
                {/* Toggle Button */}
                <div className={`mt-4 md:mt-0 ${showFilter2 ? "inline-block p-[1px] rounded-[10px] bg-gradient-to-r from-[#FF4F6D] to-[#6C3DF0]" : "inline-block p-[1px] rounded-[10px] bg-gradient-to-r hover:from-[#FF4F6D] hover:to-[#6C3DF0]"}`}>
                    <button
                        onClick={() => document.getElementById('my_modal_4').showModal()}
                        className={`py-3 md:px-6 px-3 rounded-[10px] flex gap-2.5 items-center text-white font-medium w-full md:w-auto md:mb-0 justify-center transition-transform relative cursor-pointer overflow-hidden hover:shadow-lg ${showFilter2 ? "waved-btn bg-gradient-to-r from-[#FF4F6D]/10 to-[#6C3DF0]/10 bg-[#10172A] border-1 border-transparent" : "border-1 border-[#7B808F] hover:border-transparent bg-gradient-to-r hover:from-[#FF4F6D]/10 hover:to-[#6C3DF0]/10 bg-[#10172A]"}`}
                    >
                        <Image
                            src={filter}
                            alt="filter"
                            className="h-4 w-4"
                        />
                        <span>{showFilter2 ? "Hide Filter" : "Show Filter"}</span>
                    </button>
                </div>
            </div>
